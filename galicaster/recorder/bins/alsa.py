...
class GCalsa(gst.Bin, base.Base):
    ...
    __gstdetails__ = (
        ...
        "Generic/Audio",
        "Plugin to capture raw audio via Alsa",
...
gobject.type_register(GCalsa)
gst.element_register(GCalsa, "gc-alsa-bin")
module_register(GCalsa, 'alsa')
